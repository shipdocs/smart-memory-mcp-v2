...
impl LogEntry {
    pub fn new(level: LogLevel, module: &str, message: &str, metadata: Option<serde_json::Value>) -> Self {
...
impl Logger {
    ...
    pub fn init(log_dir: &str, console_level: LogLevel, file_level: LogLevel) -> std::io::Result<()> {
        ...
        log(
            LogLevel::Info,
            "logging",
            &format!("Logging initialized. Console level: {}, File level: {}", 
        ...
        if let Ok(metadata) = fs::metadata(&log_file_path) {
            if metadata.len() > self.max_file_size {
                ...
                log(
                    LogLevel::Info,
                    "logging",
                    &format!("Log file rotated. Previous log saved to {}", backup_path.display()),
                    None,
                );
            }
        }
...
macro_rules! log_trace {
    ...
    ($module:expr, $message:expr, $metadata:expr) => {
        $crate::logging::log($crate::logging::LogLevel::Trace, $module, $message, Some($metadata))
    };
}
...
macro_rules! log_debug {
    ...
    ($module:expr, $message:expr, $metadata:expr) => {
        $crate::logging::log($crate::logging::LogLevel::Debug, $module, $message, Some($metadata))
    };
}
...
macro_rules! log_info {
    ...
    ($module:expr, $message:expr, $metadata:expr) => {
        $crate::logging::log($crate::logging::LogLevel::Info, $module, $message, Some($metadata))
    };
}
...
macro_rules! log_warning {
    ...
    ($module:expr, $message:expr, $metadata:expr) => {
        $crate::logging::log($crate::logging::LogLevel::Warning, $module, $message, Some($metadata))
    };
}
...
macro_rules! log_error {
    ...
    ($module:expr, $message:expr, $metadata:expr) => {
        $crate::logging::log($crate::logging::LogLevel::Error, $module, $message, Some($metadata))
    };
}
...
macro_rules! log_critical {
    ...
    ($module:expr, $message:expr, $metadata:expr) => {
        $crate::logging::log($crate::logging::LogLevel::Critical, $module, $message, Some($metadata))
    };
}